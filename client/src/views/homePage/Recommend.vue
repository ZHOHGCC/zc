...
<script>
import addRec from './visible/addRec'
export default {
  name: 'basetable',
  data () {
    return {
  ...
  methods: {
    ...
    // -------------------------------------------------------------------------------
    getList () {
      this.$axios.get("/home/recommend").then(res => {
    ...
    deleteRow (row) {
      this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
        ...
        let id = row.id
        this.$axios.delete(`/home/recommend/${id}`, {          params: {
            id: id
          }        }).then(() => {
          this.$message({
            type: 'success',
